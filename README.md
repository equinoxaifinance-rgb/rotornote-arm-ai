...
Four native Arm64 Neoverse-N2 runs over identical linear-head FP32, INT8, and WASM hashes measured **3.2164×**, **3.2819×**, **3.2805×**, and **3.2906× paired-median end-to-end speedups**. Their deterministic bootstrap 95% intervals were **3.1751×–3.2539×**, **3.2512×–3.3015×**, **3.2361×–3.3111×**, and **3.2569×–3.3097×** across 51 alternating-order samples per run. Each rebuilt the repository and proved exact NEON `vdotq_s32` agreement; the current run passed 29/29 tests. These are workload-specific repeatability receipts—not energy, fleet, or universal-device claims. [Inspect runs 31693588831](https://github.com/equinoxaifinance-rgb/rotornote-arm-ai/actions/runs/31693588831), [31693809937](https://github.com/equinoxaifinance-rgb/rotornote-arm-ai/actions/runs/31693809937), [31694629861](https://github.com/equinoxaifinance-rgb/rotornote-arm-ai/actions/runs/31694629861), and [current run 31698228016](https://github.com/equinoxaifinance-rgb/rotornote-arm-ai/actions/runs/31698228016).
...
FP32 learned bytes are 20,804; row-wise INT8 learned bytes are 5,492, a 73.60% reduction. Across the complete 2,925-signal bank the engines preserve 100% label agreement, with 0.000417 p99 and 0.002414 maximum probability drift. `POST /api/anomaly?engine=optimized` accepts one uniaxial channel plus sample rate and positive operating RPM. The browser includes one attributed physical demo signal. Its native timing is emitted independently per frozen commit and never conflated with the linear head's 3.2x claim.
