...
The optimized artifact reduces model weight bytes from 784 to 208 (73.47%). Across all 40,000 real windows, INT8 preserves 99.7825% window labels, 100% four-channel recording labels, and a 0.02774 p99 probability delta. On the current commit, native Arm64 run 31690244613 measured a 3.1498× paired-median end-to-end speedup with a 3.1264×–3.1711× bootstrap 95% interval. The raw evidence, machine record, artifact hashes, test output, and exact NEON witness are preserved under `receipts/native-arm64/run-31690244613/`.
