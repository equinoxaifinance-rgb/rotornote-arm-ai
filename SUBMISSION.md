...
The optimized artifact reduces model weight bytes from 784 to 208 (73.47%). Across all 2,000 real four-channel recordings, INT8 preserves 100% of production labels with a 2.80e-10 p99 probability delta and a 0.01996 maximum delta. Two native Neoverse-N2 repeats over identical artifact hashes measured 3.2164× and 3.2819× paired-median end-to-end speedups; their 95% intervals were 3.1751×–3.2539× and 3.2512×–3.3015×.
