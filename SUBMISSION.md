...
The optimized artifact reduces model weight bytes from 784 to 208 (73.47%). Across all 2,000 real four-channel recordings, INT8 preserves 100% of production labels with a 2.80e-10 p99 probability delta and a 0.01996 maximum delta. Native Neoverse-N2 run 31693588831 measured a 3.2164× paired-median end-to-end speedup with a 3.1751×–3.2539× bootstrap 95% interval and binds the exact model artifacts by SHA-256.
