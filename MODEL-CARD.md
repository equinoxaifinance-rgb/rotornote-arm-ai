...
Two SHA-256-pinned CC BY bearing archives produced 100% `review_required` decisions through the canonical one-channel anomaly route. The axial dataset (DOI `10.17632/chwhh9n3bf.2`) contributes 28 records: four healthy captures and 24 seeded-spall captures at two loads and two speeds. The Zhenjiang dataset (DOI `10.17632/xfj9t7cprb.1`) contributes 35 physical traces challenged across all seven documented operating speeds, for 245 boundary executions. Broad FP32/INT8 decisions agreed on every execution. This demonstrates fail-closed behavior on two separate rigs only, not bearing detection accuracy or field validation.
