...
Runs 31693588831, 31693809937, 31694629861, and 31698228016 measured identical linear-head FP32, INT8, and WASM hashes on native Arm64 Neoverse-N2 runners under Node 22.18.0. Each used 51 alternating-order samples of 2,048 inferences. Their paired-median speedups were **3.2164×**, **3.2819×**, **3.2805×**, and **3.2906×**, with deterministic bootstrap 95% intervals of **3.1751×–3.2539×**, **3.2512×–3.3015×**, **3.2361×–3.3111×**, and **3.2569×–3.3097×**. All four preserved 100% label agreement on the benchmark feature bank.
...
Prior deep-head receipts are preserved engineering history but do not establish timing for this pruned artifact. The current workflow emits and gates a separate native receipt; this timing is never substituted for the linear head's speed claim.
